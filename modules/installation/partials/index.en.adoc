= Installation
:description: Installation of Septic Card for Home Assistant — connecting a custom card for monitoring septic tank fill level.
:keywords: Septic, Home Assistant, installation, custom card, Lovelace, dashboard, septic monitoring
...
The card can be installed via *Home Assistant Community Store (HACS)* using a custom repository.

This is the recommended installation method, as it allows you to receive updates automatically and ensures correct integration with Home Assistant.
